...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Request1 :  IEquatable<Request1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Request1" /> class.
        /// </summary>
        ...
        public Request1(string exchange = default(string), string market = default(string), string dataFormat = default(string), string orient = default(string), string startDate = default(string), string endDate = default(string))
        {
        ...
        {
            return this.Equals(input as Request1);
        }

        /// <summary>
        /// Returns true if Request1 instances are equal
        /// </summary>
        /// <param name="input">Instance of Request1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Request1 input)
        {
            if (input == null)
                return false;
