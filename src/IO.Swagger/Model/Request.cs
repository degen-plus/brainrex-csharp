...
namespace IO.Swagger.Model
{
    ...
    public partial class Request :  IEquatable<Request>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="blockchain">Name of the exchange.</param>
        ...
        public Request(string blockchain = default(string), string market = default(string), string dataFormat = default(string), string orient = default(string), string startDate = default(string), string endDate = default(string))
        {
